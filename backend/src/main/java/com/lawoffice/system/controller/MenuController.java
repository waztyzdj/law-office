...
public class MenuController {
    ...
    public BaseResult<List<MenuRouteDTO>> getAllMenus(HttpServletRequest request) {
        try {
            ...
            // 转换为树形菜单结构
            List<MenuRouteDTO> menuTree = buildMenuTree(permissions);
    ...
    private MenuRouteDTO buildMenuRoute(Permission permission, List<Permission> allPermissions) {
        ...
        // 设置meta
        com.lawoffice.system.dto.MenuMetaDTO meta = buildMenuMeta(permission);
     ...
     * 构建菜单元数据
     */
    private com.lawoffice.system.dto.MenuMetaDTO buildMenuMeta(Permission permission) {
        com.lawoffice.system.dto.MenuMetaDTO meta = new com.lawoffice.system.dto.MenuMetaDTO();
