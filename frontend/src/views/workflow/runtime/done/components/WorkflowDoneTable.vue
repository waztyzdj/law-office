...
import { getWorkflowDoneColumns } from '../hooks/useWorkflowDoneColumns';
...
const emit = defineEmits<{
  ...
  detail: [record: RuntimeTaskInfo];
}>();

const filterStateRef = toRef(props, 'activeFilters');
const tableConfig = computed(() =>
  getWorkflowDoneColumns(filterStateRef, emit, props.pagination),
);
</script>
